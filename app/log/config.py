...
logging_config = {
    ...
    "handlers": {
        "queue_handler": {
            "class": "logging.handlers.QueueHandler",
            "handlers": ["stdout_core_info", "stderr_core_error", "stderr_payment_error", "stdout_dev"]
        },
        "stdout_core_info": {
            "class": "logging.StreamHandler",
            "formatter": "user_info",
   ...
   "loggers": {
        ...
        "core_api": {
            "handlers": ["stdout_core_info", "stderr_core_error"],
            "level": "INFO"
        },
        "payment": {
            "handlers": ["stdout_core_info", "stderr_payment_error"],
            "level": "INFO"
        },
        "raw_extentions": {
            "handlers": ["stdout_dev"],
